...
namespace SlnGen.Core.Projects
{
    ...
    {
        public NetFrameworkProject(string assemblyName, string outputType, NetFrameworkPlatform targetFrameworkVersion) :
            this(assemblyName, Guid.NewGuid(), outputType, targetFrameworkVersion) { }

        public NetFrameworkProject(string assemblyName, Guid assemblyGuid, string outputType, NetFrameworkPlatform targetFrameworkVersion) : 
